...
var professionals_component_1 = require('./professionals.component');
var ProfessionalsModule = (function () {
    ...
    ProfessionalsModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [professionals_component_1.Professionals],
            bootstrap: [professionals_component_1.Professionals]
        }), 
